 ...
 * @author ecolight
 */
public abstract class UUIDTaskBase {
     ...
     * @param plg_ 
     */
    public UUIDTaskBase(PluginFrame plg_) {
        plg = plg_;
        log = plg.getLogger();
     ...
     */
    abstract public void asyncThread(UUIDThread thread, UUIDDB db, Connection con, UUIDPayload data) throws SQLException;
     ...
     * @param data 
     */
    abstract public void mainThread(UUIDThread thread, UUIDPayload data);
}
