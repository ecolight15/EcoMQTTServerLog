...
public class EcoUserUUIDData {
    private EcoMQTTServerLog plg = null;
     ...
     */
    public EcoUserUUIDData(EcoMQTTServerLog plg) {
        this.plg = plg;
    }
     ...
     * @param time 時刻
     */
    public EcoUserUUIDData(EcoMQTTServerLog plg, UUID uuid, String name, Date time) {
        this.plg = plg;
        this.uuid = uuid;
        this.name = name;
        this.time = time;
